...
namespace Notepad
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.Text = "Hafiz Muhammad Mashhood Notepad";
       ...
       private void newToolStripMenuItem_Click(object sender, EventArgs e)
       {
           if (textBox1.Text != "")
           {
               ...
               DialogResult dr = MessageBox.Show("Do you Want Save Chenges ?", "Hafiz Muhammad Mashhood Notepad", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
       ...
       {
           MessageBox.Show("Creator Hafiz Muhammad Mashhood", "Hafiz Muhammad Mashhood NotePad", MessageBoxButtons.OK, MessageBoxIcon.Information);
       }
